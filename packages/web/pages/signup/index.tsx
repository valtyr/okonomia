  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 p-4">
      <div className="sm:grid sm:grid-cols-2 sm:gap-10">
        <div className="py-9 text-sm space-y-4">
          ...
          <p>
            Stjórnin er búin að skipuleggja stappfulla dagskrá fyrir veturinn og
            Dollý getur ekki beðið eftir því að djamma með ykkur.
          </p>
          ...
          <ul className="list-disc text-gray-300 pl-8 space-y-1">
            ...
            <li>
              <span className="text-black">
                Afslátt á{' '}
                <span className="font-semibold text-blue-700">árshátíð</span> og
                skíðaferð
              </span>
            </li>
            <li>
            ...
            <li>
              <span className="text-black">
                Kostninga- og framboðsrétt á aðalfundi Ökonomíu
              </span>
            </li>
            <li>
              <span className="text-black">
          ...
          <p className="text-xs max-w-[280px] text-gray-400 pt-2">
            Allir nemendur HÍ eru velkomnir í Ökonomíu óháð því hvort þeir séu í
            Hagfræði.
          </p>
        </div>
        <div
          ...
          ref={formRef}
        >
          <h2 className="font-hero text-lg text-gray-500 py-4">
            Skráðu þig í{' '}
